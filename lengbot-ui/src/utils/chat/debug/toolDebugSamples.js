...
export const TOOL_DEBUG_SAMPLES = {
    ...
    results: [
      {
        ...
        knowledge_id: '1001',
        content: 'LengBot 是一个轻量级 Java AI Agent 平台，支持 RAG、工作流与多工具调用。',
        score: 0.92,
      },
      {
        result_type: 'qa_pair',
  ...
  get_mindmap: sample('get_mindmap', {
    ...
    mindmap: {
      name: 'LengBot 架构',
      children: [
        { name: 'lengbot-server', children: [{ name: 'Agent' }, { name: 'RAG' }] },
        { name: 'lengbot-ui', children: [{ name: 'Chat' }, { name: 'Workflow' }] },
      ],
    },
  }),
  ...
  image_generation: sample('image_generation', {
    image_url: 'https://picsum.photos/seed/lengbot-debug/512/512',
    ...
    artifacts: [
      {
        ...
        url: 'https://picsum.photos/seed/lengbot-chart/400/300',
        downloadUrl: 'https://picsum.photos/seed/lengbot-chart/400/300',
        size: 102400,
  ...
  install_skill: sample('install_skill', {
    ...
    total: 1,
    installed: [{ slug: 'pdf-summary', displayName: 'PDF 摘要', activated: true }],
    errors: [],
  }),
