...
function buildLlmNode() {
  ...
  return [
    ...
    },
    {
      ...
      durationMs: 1280,
      outputs: {
        text: 'LengBot 是轻量级 Java AI Agent 平台，支持 RAG、工作流与 Tool 调用。',
...
function buildRetrievalNode() {
  ...
  return [
    ...
    },
    {
      ...
      outputs: {
        results: [
          { documentName: '架构设计.md', content: 'LengBot 采用模块化单体架构...', score: 0.92 },
  ...
  return [
    {
      ...
      nodeLabel: 'HTTP 请求',
      stepIndex: 0,
      input: { url: 'https://api.example.com/status', method: 'GET' },
    },
    {
      type: 'workflow_node_complete',
      nodeId: id,
