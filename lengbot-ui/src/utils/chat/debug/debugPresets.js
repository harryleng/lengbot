...
说明：列表后的普通段落不应被缩进。`,
  ...
  },
  {
    ...
    message: {
      role: 'assistant',
      content: '根据知识库检索结果，LengBot 支持 RAG 与工作流编排。',
      metadata: {
        toolEvents: [
          {
            type: 'tool_call',
            ...
            args: JSON.stringify({ query: 'LengBot 功能' }),
            contentOffset: 0,
          },
          {
            type: 'tool_result',
      ...
      metadata: {
        toolEvents: [
          ...
          },
          {
            ...
            delegationIndex: 0,
            contentOffset: 0,
            result: JSON.stringify({ results: [{ title: 'LengBot', snippet: 'Java AI Agent 平台' }] }),
          },
          {
            type: 'subagent_token',
            subagentName: 'research-agent',
            content: '根据检索，LengBot 支持 RAG 与工作流编排。',
            delegationIndex: 0,
            contentOffset: 0,
          },
          {
            ...
            delegationIndex: 0,
            contentOffset: 0,
            result: '根据检索，LengBot 支持 RAG 与工作流编排。',
          },
        ],
        workflowEvents: [],
        reasoningContent: '',
        ...
        toolEvents: [
          {
            ...
            tasks: [
              {
                task_index: 0,
                task_id: 'subagent_task_debug_research',
                subagent_name: 'research-agent',
                task: '检索 LengBot 的核心能力并用 Markdown 总结。',
              },
              {
                task_index: 1,
                task_id: 'subagent_task_debug_arch',
                subagent_name: 'architect-agent',
                task: '给出模块职责和依赖关系。',
              },
            ],
          },
          ...
          },
          {
            ...
            contentOffset: 0,
            delegationIndex: 0,
            result: { status: 'completed', reply: '## 核心能力\n\n- Agent 对话\n- **RAG** 知识库\n- 工作流编排' },
          },
          {
            type: 'subagent_task_done',
            batch_id: 'subagent_batch_debug_001',
            task_id: 'subagent_task_debug_arch',
            task_index: 1,
            subagentName: 'architect-agent',
            contentOffset: 0,
            delegationIndex: 0,
            result: { status: 'completed', reply: '## 模块分层\n\n`server → agent → tool`' },
          },
          {
            type: 'subagent_batch_done',
            batch_id: 'subagent_batch_debug_001',
            status: 'completed',
            contentOffset: 0,
            delegationIndex: 0,
