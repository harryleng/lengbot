...
export const TEXT_LIKE_EXTENSIONS = new Set([...TEXT_SOURCE_PREVIEW_EXTENSIONS, 'html', 'htm'])

/** 知识库不提供「源文件预览」的 Office 类型（与 KnowledgeDetail.hasSourcePreview 一致） */
export const OFFICE_NO_SOURCE_PREVIEW_EXTENSIONS = new Set(['doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx'])
...
/** 图片源文件预览扩展名 */
export const IMAGE_SOURCE_PREVIEW_EXTENSIONS = new Set(['png', 'jpg', 'jpeg', 'gif', 'bmp', 'webp', 'svg'])
