<template>
  <div class="rag-eval-tab">
    ...
    <!-- 结果详情弹窗 -->
    <EvalResultDetailModal v-model:open="detailVisible" :knowledge-id="knowledgeId" :result="selectedResult" />
  </div>
</template>
...
import { listBenchmarks, listEvalResults, runEvaluation, deleteEvalResult } from '../../api/knowledgeEval'
