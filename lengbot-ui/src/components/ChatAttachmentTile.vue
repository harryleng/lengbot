<template>
  <div class="chat-att-tile" :class="[`chat-att-tile--${att.type || 'file'}`, { 'is-uploading': uploading }]">
    <button v-if="!uploading && canPreview" type="button" class="chat-att-tile-btn" @click="$emit('preview', att)">
      <img v-if="showThumb" :src="thumbUrl" :alt="att.fileName || ''" class="chat-att-tile-img" />
...
import { EyeOutlined, CloseOutlined, PlayCircleOutlined, LoadingOutlined } from '@ant-design/icons-vue'
