<template>
  <div class="chat-input-wrapper">
    <div class="chat-input-shell">
      ...
      />
      <ChatReplyPreviewBar :reply-to="replyTo" @cancel-reply="$emit('cancel-reply')" />
      ...
      <div class="chat-input">
        ...
        >
          <template #content>
            <div class="attach-menu">
              <button v-if="showImageOption" type="button" class="attach-menu-item" @click="onPickImage">
              ...
              <button v-if="showDocumentOption" type="button" class="attach-menu-item" @click="onPickFile">
        ...
        <div class="chat-input-actions">
          ...
          <button v-if="loading" class="btn-stop" @click="$emit('stop')" title="停止生成">
            <PauseCircleOutlined />
          </button>
          <button v-else class="btn-send" :disabled="!canSend || askUserBlocked" @click="$emit('send')">
            <SendOutlined />
          </button>
        </div>
      </div>
...
@keyframes attach-btn-pulse {
  0%,
  100% {
    box-shadow: 0 0 0 0 rgba(0, 112, 243, 0.35);
  }
  50% {
