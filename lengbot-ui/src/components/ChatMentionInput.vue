<template>
  <div class="chat-mention-input-wrap">
    ...
    />
    <Teleport to="body">
      <div v-show="chipTooltip.visible" class="mention-chip-floating-tip" :style="chipTooltip.style">
...
const { mentions, mentionOptions, mentionLoading, picker, detectMentionQuery, clearMentions, serializeForRequest } =
  useChatMentions(
    () => props.agentId,
