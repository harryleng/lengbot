<template>
  <a-modal v-model:open="visible" title="从模板导入" :width="960" :mask-closable="false">
          ...
          <div class="template-list scroll-area-y">
            ...
            >
              ...
              <div class="template-item-tags" v-if="t.tags">
                <a-tag v-for="tag in t.tags.split(',').slice(0, 2)" :key="tag" color="blue" size="small">
                  {{ tag.trim() }}
                </a-tag>
              </div>
            </div>
