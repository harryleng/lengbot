        ...
        <div class="sd-detail-container">
          ...
          <div v-if="data.documents?.length" class="sd-detail-list">
            ...
            <div class="sd-detail-cards">
              <div v-for="(doc, i) in data.documents" :key="i" class="sd-detail-card">
...
import { FolderOutlined, FileTextOutlined, EyeOutlined, DatabaseOutlined, InboxOutlined } from '@ant-design/icons-vue'
import {
