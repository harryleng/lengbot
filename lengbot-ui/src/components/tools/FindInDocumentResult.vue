    ...
    <template v-else>
      ...
      <template v-if="data.mode === 'open'">
        <div class="fid-header">
          ...
          <span class="fid-header-info">
            共 {{ data.total_lines }} 行，第 {{ data.start_line }}-{{ data.end_line }} 行
          </span>
            ...
            <div class="fid-detail-docs">
              ...
              <div v-for="(doc, di) in data.documents" :key="di" class="fid-detail-doc">
                ...
                <div class="fid-doc-matches">
                  <div v-for="(match, mi) in doc.matches" :key="mi" class="fid-match-item">
...
import { FileTextOutlined, FileSearchOutlined, EyeOutlined } from '@ant-design/icons-vue'
import {
