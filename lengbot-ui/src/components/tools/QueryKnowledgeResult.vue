    ...
    <template v-else>
      ...
      <div v-if="data.results?.length" class="qkr-results">
        ...
        <div class="qkr-card-list">
          <div v-for="(item, i) in visibleItems" :key="i" class="qkr-card" @click="openItemDetail(item)">
...
import { SearchOutlined, QuestionCircleOutlined, FileTextOutlined, EyeOutlined } from '@ant-design/icons-vue'
import {
