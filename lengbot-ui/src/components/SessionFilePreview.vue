  ...
  <div class="session-file-preview">
    ...
    <div v-else class="sfp-content">
      ...
      <div class="sfp-body">
        ...
        <iframe
          v-else-if="previewType === 'pdf' && contentUrl"
          :src="contentUrl"
          class="sfp-pdf"
          title="pdf-preview"
        ></iframe>
        ...
        <div v-else-if="previewType === 'download'" class="sfp-fallback">
          <p>该文件类型不支持在线预览</p>
          <button type="button" class="sfp-download" @click="handleFallbackDownload">
            <DownloadOutlined />
            下载查看
          </button>
        </div>
        <div v-else class="sfp-fallback">
          <p>{{ message || '暂不支持预览' }}</p>
          <button v-if="contentUrl" type="button" class="sfp-download" @click="handleFallbackDownload">
            <DownloadOutlined />
            下载
          </button>
        </div>
