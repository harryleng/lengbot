  ...
  <div class="tool-call-log-page">
    ...
    <div class="filter-bar">
      ...
      <a-range-picker
        ...
        style="width: 380px"
      />
      <a-button type="primary" @click="loadData(1)">
        <SearchOutlined />
        查询
      </a-button>
    </div>
    ...
    <!-- 详情弹窗 -->
    <a-modal v-model:open="detailVisible" title="工具调用详情" :width="720" :footer="null" :mask-closable="false">
      <div v-if="detailRecord" class="modal-scroll-body">
        <a-descriptions :column="2" size="small" bordered style="margin-bottom: 16px">
          ...
          <a-descriptions-item label="状态">
            <a-tag
              :color="
                detailRecord.status === 'success' ? 'success' : detailRecord.status === 'error' ? 'error' : 'processing'
              "
            >
