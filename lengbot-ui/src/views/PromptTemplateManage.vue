  ...
  <div class="page">
    <div class="page-header">
      ...
      <div class="page-header-actions">
        <a-input v-model:value="searchText" placeholder="搜索模板..." allow-clear style="width: 180px">
    ...
    <a-spin :spinning="loading">
      <div class="template-grid">
        ...
        >
          <template #info>
            <a-tooltip :title="t.promptTemplateKey">
    ...
    <!-- 模板预览弹窗 -->
    <a-modal v-model:open="previewVisible" title="模板预览" :width="640" :footer="null" :mask-closable="false">
      ...
      <div class="dialog-scroll-body">
        <a-form :model="form" :label-col="{ flex: '0 0 100px' }">
          <a-form-item label="模板标识" required>
            <a-input
              v-model:value="form.promptTemplateKey"
              :maxlength="30"
              show-count
          ...
          <a-form-item label="描述">
            <a-textarea
              v-model:value="form.templateDesc"
              :rows="2"
              :maxlength="50"
              show-count
              placeholder="模板用途描述 (不超过50字)"
            />
          </a-form-item>
          <a-form-item label="模板内容" required>
            <a-textarea
              ...
              :maxlength="5000"
              show-count
              placeholder="使用 {{变量名}} 定义变量 (不超过5000字)"
...
import { getPromptTemplates, createPromptTemplate, updatePromptTemplate, deletePromptTemplate } from '../api/prompt'
