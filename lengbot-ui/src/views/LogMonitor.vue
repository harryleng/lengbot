<template>
  <div class="page">
    ...
    <div class="filter-bar">
      ...
      <a-input v-model:value="searchText" placeholder="搜索日志内容..." allow-clear style="width: 280px">
...
const filteredLogs = computed(() => {
  ...
  if (searchText.value) {
    ...
    result = result.filter(
      (l) => l.message?.toLowerCase().includes(keyword) || l.logger?.toLowerCase().includes(keyword)
    )
  }
  return result
})
