  ...
  <div class="task-center">
    <div class="page-header">
      ...
      <div class="page-header-right">
        <a-input v-model:value="searchText" placeholder="搜索任务名称..." allow-clear style="width: 220px">
    ...
    <div class="type-filter-bar">
      <span class="type-filter-item" :class="{ active: typeFilter === '' }" @click="typeFilter = ''">全部</span>
      <span
        ...
        <template #bodyCell="{ column, record }">
          ...
          <template v-else-if="column.key === 'action'">
            <a-tooltip
              ...
              title="取消任务"
              :get-popup-container="(t) => t.parentElement"
            >
              <a-button type="link" size="small" danger @click.stop="handleCancel(record)">
                <StopOutlined />
              </a-button>
            </a-tooltip>
            <a-tooltip v-else title="删除" :get-popup-container="(t) => t.parentElement">
    ...
    <!-- 任务详情抽屉 -->
    <a-drawer v-model:open="detailVisible" title="任务详情" :width="560" :footer="null">
      <template v-if="detailTask">
        <a-descriptions :column="1" bordered size="small" class="detail-descriptions">
          ...
          <a-descriptions-item label="状态">
            <a-badge
              :status="statusBadge[detailTask.status]"
              :text="statusMap[detailTask.status] || detailTask.status"
            />
          ...
          <a-descriptions-item label="进度">
            <div class="progress-cell">
              <a-progress
                ...
                :status="
                  detailTask.status === 'failed' ? 'exception' : detailTask.status === 'success' ? 'success' : 'active'
                "
                :show-info="false"
                size="small"
              />
