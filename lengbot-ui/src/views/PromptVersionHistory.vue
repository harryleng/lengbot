<template>
  <div class="detail-page">
    ...
    <!-- 版本详情弹窗 -->
    <a-modal v-model:open="detailVisible" title="版本详情" :width="700" :mask-closable="false">
...
import { HistoryOutlined, SwapOutlined, RollbackOutlined } from '@ant-design/icons-vue'
...
.diff-line.unchanged .diff-line-icon {
  color: var(--color-mute);
}
.diff-line.removed {
  background: var(--color-error-bg);
}
.diff-line.removed .diff-line-icon {
  color: #dc2626;
}
...
.diff-line.added .diff-line-icon {
  color: #16a34a;
}
...
.diff-line.modified .diff-line-icon {
  color: #d97706;
}
.diff-line.modified .diff-line-old {
  color: #dc2626;
  text-decoration: line-through;
}
.diff-line.modified .diff-line-new {
  color: #16a34a;
  font-weight: 600;
}
</style>
