    ...
    <div class="feedback-page">
      ...
      <a-spin :spinning="loading">
        ...
        <div v-else class="feedback-list">
          <div v-for="fb in feedbacks" :key="fb.id" class="feedback-item" @click="confirmGoToSession(fb)">
            ...
            <div v-if="fb.rating === 'dislike' && fb.reason" class="feedback-reason-block" @click.stop>
