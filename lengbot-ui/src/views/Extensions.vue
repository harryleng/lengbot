    ...
    >
      <template #actions>
        ...
        <button class="lb-btn" @click="handleRefresh">
          <ReloadOutlined :spin="currentLoading" />
          刷新
        </button>
        <button
          v-if="activeTab === 'skills'"
          class="lb-btn lb-btn--accent lb-btn--accent--mcp"
          @click="skillRef?.openImportModal()"
        >
          <UploadOutlined />
          ZIP 导入
        </button>
        <button
          v-if="activeTab === 'skills'"
          class="lb-btn lb-btn--accent lb-btn--accent--default"
          @click="skillRef?.openRemoteInstallModal()"
        >
