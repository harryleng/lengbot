<template>
  <div class="config-panel">
    ...
    <div class="panel-body" :class="{ 'panel-body-readonly': isVersionPreview && !forceReadonly }">
      ...
      <a-alert
        v-if="isVersionPreview && !forceReadonly"
        type="info"
        show-icon
        message="历史版本预览（只读）"
...
defineEmits(['close', 'open-example', 'open-test', 'copy', 'sync', 'knowledge-change', 'tool-change', 'delete'])
</script>
