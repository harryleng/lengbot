...
defineProps({
  flowId: { type: String, default: 'lengbot-workflow-edit' },
...
defineEmits([
  ...
  'edge-mouse-leave',
  'pane-click',
  'edge-insert-pointer-enter',
  'edge-insert-pointer-leave',
  'insert-node-on-edge',
  'edge-insert-menu-open',
  'edge-insert-menu-close',
  'version-panel-drag-start',
  'close-version-panel',
  'select-version',
  'overwrite-draft',
])
