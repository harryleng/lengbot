<template>
  ...
  >
    ...
    <template #node-api="slotProps">
      <GenericWorkflowNode v-bind="slotProps" node-type="api" summary-key="url" />
    </template>
    ...
    <template #node-variable="slotProps">
      <GenericWorkflowNode v-bind="slotProps" node-type="variable" summary-key="variableName" />
    </template>
    ...
    <template #node-mcp="slotProps">
      <GenericWorkflowNode v-bind="slotProps" node-type="mcp" summary-key="mcpServerName" />
    </template>
    <template #node-input="slotProps"><GenericWorkflowNode v-bind="slotProps" node-type="input" /></template>
    <template #node-confirm="slotProps">
      <GenericWorkflowNode v-bind="slotProps" node-type="confirm" summary-key="message" />
    </template>
    <template #node-output="slotProps">
      <GenericWorkflowNode v-bind="slotProps" node-type="output" summary-key="output" />
    </template>
    <template #node-variable_handle="slotProps">
      <GenericWorkflowNode v-bind="slotProps" node-type="variable_handle" />
    </template>
    <template #node-parameter_extractor="slotProps">
      <GenericWorkflowNode v-bind="slotProps" node-type="parameter_extractor" />
    </template>
    <template #node-app_component="slotProps">
      <GenericWorkflowNode v-bind="slotProps" node-type="app_component" summary-key="componentName" />
    </template>
