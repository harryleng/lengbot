  ...
  <div class="code-editor" :class="{ fullscreen: isFullscreen }">
    ...
    >
      <div class="code-editor code-editor--modal">
        <div class="code-editor-toolbar">
          <a-select :value="language" :disabled="disabled" size="small" style="width: 130px" @change="onLanguageChange">
            <a-select-option v-for="lang in SCRIPT_LANGUAGES" :key="lang.value" :value="lang.value">
              {{ lang.label }}
            </a-select-option>
          </a-select>
...
.code-editor-highlight :deep(.hljs-keyword) {
  color: #c084fc;
}
.code-editor-highlight :deep(.hljs-string) {
  color: #86efac;
}
.code-editor-highlight :deep(.hljs-number) {
  color: #fcd34d;
}
.code-editor-highlight :deep(.hljs-comment) {
  color: var(--color-mute);
}
.code-editor-highlight :deep(.hljs-function) {
  color: #7dd3fc;
}
