    ...
    <div class="init-card">
      ...
      <div class="card-right">
        <div class="form-header">
          <img src="/lengbot-logo-single.png" alt="LengBot" class="form-logo" />
          <h2>系统初始化</h2>
          <p>创建管理员账号以开始使用 LengBot</p>
        </div>
        ...
        <form class="init-form" @submit.prevent="handleInit">
          <div class="form-item">
            ...
            <div class="input-wrapper">
              ...
              <input v-model="form.username" type="text" placeholder="请输入管理员用户名" autocomplete="username" />
            </div>
          </div>
