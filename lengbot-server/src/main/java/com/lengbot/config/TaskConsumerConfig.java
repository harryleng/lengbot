...
import com.lengbot.common.task.FatalTaskException;
import com.lengbot.common.task.RetryableTaskException;
...
import com.lengbot.service.port.TaskInterruptPort;
import com.lengbot.task.RetryPolicy;
import com.lengbot.task.RetryPolicyProperties;
import com.lengbot.task.TaskExecutor;
import com.lengbot.task.TaskMessage;
...
public class TaskConsumerConfig implements TaskInterruptPort {
    ...
    /** 默认组（短任务）线程池大小 */
    @Value("${lengbot.task.consumer.pool-size:2}")
    ...
    @SuppressWarnings("unused")
    private List<com.lengbot.task.StaleMessage> listStaleForDebug(TaskType.Group group) {
