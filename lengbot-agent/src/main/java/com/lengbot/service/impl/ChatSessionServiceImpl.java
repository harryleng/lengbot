...
import com.lengbot.mapper.ChatSessionMapper;
...
import com.lengbot.service.LlmTraceService;
...
public class ChatSessionServiceImpl extends ServiceImpl<ChatSessionMapper, ChatSession>
    ...
    private final ThreadPoolTaskExecutor lengBotExecutor;
    ...
    private static final String CACHE_PREFIX = "lengbot:session:";
    private static final String LIST_CACHE_PREFIX = "lengbot:session:list:";
    private static final String LIST_VERSION_PREFIX = "lengbot:session:list:ver:";
    ...
    public void deleteSession(Long sessionId) {
        ...
        runAfterCommit(() -> lengBotExecutor.execute(() -> {
            try {
    ...
    public String exportSession(Long userId, Long sessionId, String format) {
        ...
        // 2. 获取全部消息（按时间正序）
        List<com.lengbot.entity.Message> messages = messageService.listBySessionId(sessionId);
    ...
    private String exportAsJson(ChatSession session, List<com.lengbot.entity.Message> messages) {
        try {
            ...
            for (com.lengbot.entity.Message msg : messages) {
    ...
    private String exportAsMarkdown(ChatSession session, List<com.lengbot.entity.Message> messages) {
    ...
    @Override
    public void appendSessionAttachments(Long sessionId, List<com.lengbot.dto.ChatAttachmentDTO> attachments, String source) {
        ...
        for (com.lengbot.dto.ChatAttachmentDTO att : attachments) {
    ...
    @Override
    public void relocateAttachmentsToSession(Long sessionId, List<com.lengbot.dto.ChatAttachmentDTO> attachments) {
