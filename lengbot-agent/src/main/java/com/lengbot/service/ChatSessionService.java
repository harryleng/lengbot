...
public interface ChatSessionService extends IService<ChatSession> {
     ...
     */
    void appendSessionAttachments(Long sessionId, List<com.lengbot.dto.ChatAttachmentDTO> attachments, String source);
     ...
     */
    void relocateAttachmentsToSession(Long sessionId, List<com.lengbot.dto.ChatAttachmentDTO> attachments);

    /**
     * 注册会话附件（AI 工具产出等，按 objectKey 去重）
     */
    void registerSessionAttachments(Long sessionId, List<com.lengbot.vo.SessionAttachmentVO> attachments);

    /**
     * 获取会话附件列表
     */
    List<com.lengbot.vo.SessionAttachmentVO> getSessionAttachments(Long sessionId);
