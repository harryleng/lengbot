...
public class InitMiddleware implements ChatMiddleware {
    ...
    public Map<String, Object> resolveRuntimeConfigMap(Agent agent, com.lengbot.dto.ChatRequestDTO request) {
    ...
    public Map<String, Object> resolveRuntimeConfigMap(Agent agent, com.lengbot.dto.ChatRequestDTO request, ChatContext ctx) {
        if (agent == null) {
            return Map.of();
        }
