...
public class MilvusUtil {
    ...
    public MilvusUtil(
            @Value("${lengbot.milvus.enabled:false}") boolean enabled,
            @Value("${lengbot.milvus.uri:http://localhost:19530}") String uri,
            @Value("${lengbot.milvus.token:}") String token,
            @Value("${lengbot.milvus.connect-timeout-ms:10000}") int connectTimeoutMs,
            @Value("${lengbot.milvus.wait-timeout-ms:30000}") int waitTimeoutMs) {
