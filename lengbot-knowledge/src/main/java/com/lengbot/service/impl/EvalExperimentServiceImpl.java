...
import com.lengbot.dto.EvalExperimentCreateDTO;
import com.lengbot.entity.*;
import com.lengbot.enums.ErrorCode;
import com.lengbot.enums.ExperimentStatus;
import com.lengbot.enums.TaskType;
import com.lengbot.mapper.EvalExperimentMapper;
...
public class EvalExperimentServiceImpl extends ServiceImpl<EvalExperimentMapper, EvalExperiment>
    ...
    private final com.lengbot.util.RedisUtil redisUtil;
     ...
     */
    private com.lengbot.dto.EvalScoreResultDTO callEvaluator(String evaluatorName,
