...
import com.lengbot.dto.DocumentEditDTO;
import com.lengbot.vo.DocumentEditSaveVO;
import com.lengbot.vo.EditableContentVO;
...
import com.lengbot.service.DocumentEditService;
...
public class DocumentEditServiceImpl implements DocumentEditService {
    ...
    private final Executor lengBotExecutor;
    ...
    private String calculateContentHash(String content) {
        try {
            return com.lengbot.util.HashUtil.md5(content.getBytes(StandardCharsets.UTF_8));
        } catch (Exception e) {
