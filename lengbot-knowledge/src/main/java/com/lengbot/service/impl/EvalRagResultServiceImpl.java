...
import com.lengbot.entity.EvalRagBenchmark;
import com.lengbot.entity.EvalRagBenchmarkItem;
import com.lengbot.entity.EvalRagResult;
import com.lengbot.entity.EvalRagResultDetail;
import com.lengbot.enums.ErrorCode;
import com.lengbot.enums.KnowledgeRole;
import com.lengbot.mapper.EvalRagResultDetailMapper;
import com.lengbot.mapper.EvalRagResultMapper;
import com.lengbot.model.ModelFactory;
import com.lengbot.service.EvalRagBenchmarkService;
import com.lengbot.service.EvalRagResultService;
import com.lengbot.service.KnowledgeMemberService;
import com.lengbot.service.eval.RagEvaluationEngine;
...
public class EvalRagResultServiceImpl
    ...
    public void executeEvaluation(Long resultId, Long benchmarkId, Long knowledgeId,
        ...
        try {
            ...
            try {
                ...
                String analysis = generateAnalysis(result, details, metrics, analysisProviderId);
    ...
    private String generateAnalysis(EvalRagResult result, List<EvalRagResultDetail> details,
                                     Map<String, Object> metrics, Long providerId) {
        // 1. 构建分析上下文
        ...
        List<Msg> messages = List.of(
                Msgs.system(systemPrompt),
                Msgs.user(context.toString())
        );

        var response = com.lengbot.util.LlmTraceContext.callWithoutTrace(() ->
                ModelCalls.call(model, messages));
        return Msgs.extractText(response).trim();
    }
