package com.lengbot.tool.registrar;
...
/**
 * 统一工具注册器
 * <p>扫描 {@code com.lengbot.tool.builtin} 和 {@code com.lengbot.tool.systemtool} 包下
...
public class ToolRegistrar {
    ...
    private static final List<String> SCAN_PACKAGES = List.of(
            "com.lengbot.tool.builtin",
            "com.lengbot.tool.systemtool",
            "com.lengbot.agent.tool.knowledge",
            "com.lengbot.agent.tool.memory"
    );
    ...
    private String generateInputSchema(Method method) {
        try {
            ...
            for (Parameter param : method.getParameters()) {
                if (param.getType().equals(ToolCallParam.class)) {
                    continue;
                }
